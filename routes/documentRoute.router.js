...
router.get("/:documentTypeId", permissions, controller.getDocumentRouteByDocumentTypeId);
router.post("/add", permissions, controller.addNewDocumentRoute);
router.delete('/delete/:documentTypeId', permissions, controller.deleteDocumentRouteById);
